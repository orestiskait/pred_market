...
def process_data(url, output_path):
    ...
    # Downloading the TSV/CSV format data
    ...
    # Define the core extracted columns in requested order
    extracted_cols = [
    ...
    # Prefix columns we want to keep at the start
    prefix_cols = ['station', 'valid']
    
    # Filter original columns, removing prefix cols, metar, and raw tmp cols
    remaining_orig = [
    ...
    # Ensure metar is at the absolute end
...
def main():
    ...
    output_dir = "/mnt/c/Users/okait/Desktop/oci_collector"
