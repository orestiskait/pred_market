...
def check_model_directory(model: str):
    """Verify the integrity and completeness of the downloaded NWP backfill data."""
    actual_dir_name = "rrfs" if model == "hrrr" else model
    model_dir = NWP_REALTIME_DIR / actual_dir_name
