...
# Reuse the Kalshi REST client from the collector module
import sys
sys.path.append(str(Path(__file__).resolve().parent.parent / "collector"))
...
class WeatherBot:
    def __init__(self):
        ...
        env_path = Path(__file__).resolve().parent.parent / "collector" / ".env"
